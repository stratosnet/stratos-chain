...
By far the most common scenario is people wanting to simply interact with the Stratos
 ...
 * Start `geth` in fast sync mode (default, can be changed with the `--syncmode` flag),
   ...
   of the Stratos network, which is very CPU intensive.
...
Transitioning towards developers, if you'd like to play around with creating Stratos
 ...
 * Instead of connecting the main Stratos network, the client will connect to the Görli
...
One of the quickest ways to get Stratos up and running on your machine is by using
Docker:
...
Stratos network via your own programs and not manually through the console. To aid
...
Stratos nodes with exposed APIs! Further, all browser tabs can access locally
...
Mining on the public Stratos network is a complex task as it's only feasible using GPUs,
