...
func init() {
	file_stratos_types_v1_account_proto_init()
	md_EthAccount = File_stratos_types_v1_account_proto.Messages().ByName("EthAccount")
...
func (x *EthAccount) slowProtoReflect() protoreflect.Message {
	mi := &file_stratos_types_v1_account_proto_msgTypes[0]
...
func (x *fastReflection_EthAccount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "stratos.types.v1.EthAccount.base_account":
		return x.BaseAccount != nil
	case "stratos.types.v1.EthAccount.code_hash":
		return x.CodeHash != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stratos.types.v1.EthAccount"))
		}
		panic(fmt.Errorf("message stratos.types.v1.EthAccount does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EthAccount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message stratos.types.v1.EthAccount does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EthAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "stratos.types.v1.EthAccount.code_hash":
		panic(fmt.Errorf("field code_hash of message stratos.types.v1.EthAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stratos.types.v1.EthAccount"))
		}
...
func (x *fastReflection_EthAccount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in stratos.types.v1.EthAccount", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EthAccount) Descriptor() ([]byte, []int) {
	return file_stratos_types_v1_account_proto_rawDescGZIP(), []int{0}
}
...
var file_stratos_types_v1_account_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x73, 0x74, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f,
	0x76, 0x31, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x10, 0x73, 0x74, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e,
	...
	0x6f, 0x74, 0x6f, 0x22, 0xe5, 0x01, 0x0a, 0x0a, 0x45, 0x74, 0x68, 0x41, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x12, 0x60, 0x0a, 0x0c, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75,
	...
	,
	...
	,
}

var (
	file_stratos_types_v1_account_proto_rawDescOnce sync.Once
	file_stratos_types_v1_account_proto_rawDescData = file_stratos_types_v1_account_proto_rawDesc
)

func file_stratos_types_v1_account_proto_rawDescGZIP() []byte {
	file_stratos_types_v1_account_proto_rawDescOnce.Do(func() {
		file_stratos_types_v1_account_proto_rawDescData = protoimpl.X.CompressGZIP(file_stratos_types_v1_account_proto_rawDescData)
	})
	return file_stratos_types_v1_account_proto_rawDescData
}

var file_stratos_types_v1_account_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_stratos_types_v1_account_proto_goTypes = []interface{}{
	(*EthAccount)(nil),          // 0: stratos.types.v1.EthAccount
	(*v1beta1.BaseAccount)(nil), // 1: cosmos.auth.v1beta1.BaseAccount
}
var file_stratos_types_v1_account_proto_depIdxs = []int32{
	1, // 0: stratos.types.v1.EthAccount.base_account:type_name -> cosmos.auth.v1beta1.BaseAccount
...
func init() { file_stratos_types_v1_account_proto_init() }
func file_stratos_types_v1_account_proto_init() {
	if File_stratos_types_v1_account_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_stratos_types_v1_account_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_stratos_types_v1_account_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_stratos_types_v1_account_proto_goTypes,
		DependencyIndexes: file_stratos_types_v1_account_proto_depIdxs,
		MessageInfos:      file_stratos_types_v1_account_proto_msgTypes,
	}.Build()
	File_stratos_types_v1_account_proto = out.File
	file_stratos_types_v1_account_proto_rawDesc = nil
	file_stratos_types_v1_account_proto_goTypes = nil
	file_stratos_types_v1_account_proto_depIdxs = nil
}
