...
// Upgrade represents the v0.12.0 upgrade
type Upgrade struct {
	mm              *module.Manager
	...
	return func(ctx sdk.Context, plan upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
		...
		for _, subspace := range u.paramsKeeper.GetSubspaces() {
			...
			case govtypes.ModuleName:
				//nolint:staticcheck
				keyTable = govtypesv1.ParamKeyTable()
			...
			case icacontrollertypes.SubModuleName:
				...
				// stratos
			case registertypes.ModuleName:
				keyTable = registertypes.ParamKeyTable()
			case pottypes.ModuleName:
				keyTable = pottypes.ParamKeyTable()
			case sdstypes.ModuleName:
				keyTable = sdstypes.ParamKeyTable()
