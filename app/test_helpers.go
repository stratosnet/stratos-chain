...
func setup(withGenesis bool, invCheckPeriod uint) (*NewApp, simapp.GenesisState) {
	db := dbm.NewMemDB()
...
func SetupWithGenesisAccounts(genAccs []authtypes.GenesisAccount, chainId string, balances ...banktypes.Balance) *NewApp {
	...
	app.Commit()
	app.BeginBlock(abci.RequestBeginBlock{Header: tmproto.Header{Height: app.LastBlockHeight() + 1, ChainID: chainId}})
...
func addTestAddrs(app *NewApp, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
...
func initAccountWithCoins(app *NewApp, ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins) {
