...
type MsgVolumeReport struct {
	WalletVolumes   []*SingleWalletVolume                   `protobuf:"bytes,1,rep,name=walletVolumes,proto3" json:"wallet_volumes" yaml:"wallet_volumes"`
	...
	ReportReference string                                  `protobuf:"bytes,4,opt,name=reportReference,proto3" json:"report_reference" yaml:"report_reference"`
	ReporterOwner   string                                  `protobuf:"bytes,5,opt,name=reporterOwner,proto3" json:"reporter_owner" yaml:"reporter_owner"`
	BLSSignature    *BLSSignatureInfo                       `protobuf:"bytes,6,opt,name=bLSSignature,proto3" json:"bls_signature" yaml:"bls_signature"`
}
...
type MsgWithdraw struct {
	...
	WalletAddress string                                   `protobuf:"bytes,2,opt,name=walletAddress,proto3" json:"wallet_address" yaml:"wallet_address"`
	TargetAddress string                                   `protobuf:"bytes,3,opt,name=targetAddress,proto3" json:"target_address" yaml:"target_address"`
}
...
type MsgSlashingResourceNode struct {
	...
	ReporterOwner  []string                                `protobuf:"bytes,2,rep,name=reporterOwner,proto3" json:"reporter_owner" yaml:"reporter_owner"`
	NetworkAddress string                                  `protobuf:"bytes,3,opt,name=networkAddress,proto3" json:"network_address" yaml:"network_address"`
	WalletAddress  string                                  `protobuf:"bytes,4,opt,name=walletAddress,proto3" json:"wallet_address" yaml:"wallet_address"`
...
var fileDescriptor_103c258cace119ca = []byte{
	...
	,
}
