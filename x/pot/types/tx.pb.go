...
type MsgLegacyWithdraw struct {
	...
	LegacyWalletAddress string                                   `protobuf:"bytes,3,opt,name=legacy_wallet_address,json=legacyWalletAddress,proto3" json:"legacy_wallet_address" yaml:"legacy_wallet_address"`
	TargetAddress       string                                   `protobuf:"bytes,4,opt,name=target_address,json=targetAddress,proto3" json:"target_address" yaml:"target_address"`
}
...
func (m *MsgLegacyWithdraw) GetLegacyWalletAddress() string {
	if m != nil {
		return m.LegacyWalletAddress
	}
	return ""
}
...
var fileDescriptor_103c258cace119ca = []byte{
	...
	,
}
...
func (m *MsgLegacyWithdraw) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LegacyWalletAddress) > 0 {
		i -= len(m.LegacyWalletAddress)
		copy(dAtA[i:], m.LegacyWalletAddress)
		i = encodeVarintTx(dAtA, i, uint64(len(m.LegacyWalletAddress)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.From) > 0 {
...
func (m *MsgLegacyWithdraw) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LegacyWalletAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LegacyWalletAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetAddress", wireType)
