...
type GenesisState struct {
	...
	MatureEpoch       sdk.Int        `json:"mature_epoch" yaml:"mature_epoch"`
}

// NewGenesisState creates a new GenesisState object
func NewGenesisState(params Params, foundationAccount sdk.AccAddress, initialUOzonePrice sdk.Int, matureEpoch sdk.Int) GenesisState {
	return GenesisState{
		Params:            params,
...
func ValidateGenesis(data GenesisState) error {
	...
	if data.MatureEpoch.LTE(sdk.ZeroInt()) {
		return ErrMatureEpoch
	}
	return nil
}
