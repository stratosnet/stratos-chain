...
func (m *EventUpdateResourceNode) GetMoniker() string {
	if m != nil {
		return m.Moniker
	}
	return ""
...
func (m *EventUpdateResourceNode) GetIdentity() string {
	if m != nil {
		return m.Identity
	}
	return ""
...
func (m *EventUpdateResourceNode) GetWebsite() string {
	if m != nil {
		return m.Website
	}
	return ""
...
func (m *EventUpdateResourceNode) GetSecurityContact() string {
	if m != nil {
...
func (m *EventUpdateResourceNode) GetDetails() string {
	if m != nil {
		return m.Details
	}
	return ""
...
var fileDescriptor_9f4bedab5b811f13 = []byte{
	...
	,
}
...
func (m *EventUpdateResourceNode) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Details) > 0 {
		...
		i = encodeVarintEvent(dAtA, i, uint64(len(m.Details)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.SecurityContact) > 0 {
		...
		i = encodeVarintEvent(dAtA, i, uint64(len(m.SecurityContact)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Website) > 0 {
		...
		i = encodeVarintEvent(dAtA, i, uint64(len(m.Website)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Identity) > 0 {
	...
	if len(m.Moniker) > 0 {
		...
		i = encodeVarintEvent(dAtA, i, uint64(len(m.Moniker)))
		i--
		dAtA[i] = 0x22
	}
