...
type GenesisState struct {
	...
	MerkleRoot           []byte                                 `protobuf:"bytes,10,opt,name=merkle_root,json=merkleRoot,proto3" json:"merkle_root" yaml:"merkle_root"`
	Commitments          []Commitment                           `protobuf:"bytes,11,rep,name=commitments,proto3" json:"commitments" yaml:"commitments"`
}
...
type Commitment struct {
	Commitment []byte `protobuf:"bytes,1,opt,name=commitment,proto3" json:"commitment" yaml:"commitment"`
...
func (*Commitment) Descriptor() ([]byte, []int) {
	return fileDescriptor_5bdab54ebea9e48e, []int{3}
}
...
func (m *Commitment) GetCommitment() []byte {
	if m != nil {
		return m.Commitment
	}
	return nil
...
func (m *Commitment) GetRoot() []byte {
	if m != nil {
		return m.Root
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Commitment)(nil), "stratos.register.v1.Commitment")
}
...
var fileDescriptor_5bdab54ebea9e48e = []byte{
	...
	,
}
...
func (this *GenesisState) Equal(that interface{}) bool {
	...
	for i := range this.Commitments {
		if !this.Commitments[i].Equal(&that1.Commitments[i]) {
			return false
		}
	}
	return true
...
func (this *Commitment) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Commitment)
	if !ok {
		that2, ok := that.(Commitment)
		if ok {
			that1 = &that2
		} else {
			return false
