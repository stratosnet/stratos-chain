...
var (
	...
	ErrInsufficientBalanceOfBondedPool    = sdkerrors.Register(ModuleName, 26, "insufficient balance of bonded pool")
	ErrInsufficientBalanceOfNotBondedPool = sdkerrors.Register(ModuleName, 27, "insufficient balance of not bonded pool")
	ErrSubAllTokens                       = sdkerrors.Register(ModuleName, 28, "error sub all tokens")
)
