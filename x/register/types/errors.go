...
var (
	...
	ErrIndexingNodeOwnerExists  = sdkerrors.Register(ModuleName, 6, "indexing node already exist for this operator address; must use new indexing node operator address")
	ErrIndexingNodePubKeyExists = sdkerrors.Register(ModuleName, 7, "indexing node already exist for this pubkey; must use new indexing node pubkey")
)
