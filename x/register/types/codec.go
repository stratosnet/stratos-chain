...
func RegisterCodec(cdc *codec.Codec) {
	...
	cdc.RegisterConcrete(MsgUpdateResourceNodeStake{}, "register/UpdateResourceNodeTx", nil)
	...
	cdc.RegisterConcrete(MsgUpdateIndexingNodeStake{}, "register/UpdateIndexingNodeTx", nil)
