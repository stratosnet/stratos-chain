...
func registerQueryRoutes(cliCtx context.CLIContext, r *mux.Router) {
	r.HandleFunc("/register/resource-node", nodesWithParamsFn(cliCtx, keeper.QueryResourceNodeByNetworkAddr)).Methods("GET")
	r.HandleFunc("/register/indexing-node", nodesWithParamsFn(cliCtx, keeper.QueryIndexingNodeByNetworkAddr)).Methods("GET")
