...
const (
	FlagPubKey                  = "pubkey"
	FlagAmount                  = "amount"
	FlagAddressResourceNodeAddr = "resource-node-addr"
...
var (
	...
	FsResourceNodeAddr = flag.NewFlagSet("", flag.ContinueOnError)
...
func init() {
	...
	FsResourceNodeAddr.String(FlagAddressResourceNodeAddr, "", "The Bech32 address of the resource node")
