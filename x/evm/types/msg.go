...
const (
	...
	// TypeMsgStratosTx defines the type string of stratos message
	TypeMsgStratosTx = "stratos"
)

// MsgStratosTx implements a cosmos equivalent structure for Ethereum transactions
...
func (msg MsgStratosTx) To() *ethcmn.Address {
