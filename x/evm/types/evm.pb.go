...
type ProxyProposalParams struct {
	...
	ConsensusDeployerAddress string `protobuf:"bytes,1,opt,name=consensus_deployer_address,json=consensusDeployerAddress,proto3" json:"consensus_deployer_address,omitempty"`
	// admin proxy address
	...
	// proxy contract for sds module
	SdsProxyAddress string `protobuf:"bytes,3,opt,name=sds_proxy_address,json=sdsProxyAddress,proto3" json:"sds_proxy_address,omitempty"`
}
...
func (m *ProxyProposalParams) GetConsensusDeployerAddress() string {
	if m != nil {
		return m.ConsensusDeployerAddress
	}
	return ""
}
...
func (m *ProxyProposalParams) GetSdsProxyAddress() string {
	if m != nil {
		return m.SdsProxyAddress
	}
	return ""
}
...
var fileDescriptor_6ee18d4714e9d670 = []byte{
	...
	,
}
...
func (m *ProxyProposalParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SdsProxyAddress) > 0 {
		i -= len(m.SdsProxyAddress)
		copy(dAtA[i:], m.SdsProxyAddress)
		i = encodeVarintEvm(dAtA, i, uint64(len(m.SdsProxyAddress)))
		i--
		dAtA[i] = 0x1a
	}
	...
	if len(m.ConsensusDeployerAddress) > 0 {
		i -= len(m.ConsensusDeployerAddress)
		copy(dAtA[i:], m.ConsensusDeployerAddress)
		i = encodeVarintEvm(dAtA, i, uint64(len(m.ConsensusDeployerAddress)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ProxyProposalParams) Size() (n int) {
	...
	var l int
	_ = l
	l = len(m.ConsensusDeployerAddress)
	if l > 0 {
		n += 1 + l + sovEvm(uint64(l))
	}
...
func (m *ProxyProposalParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConsensusDeployerAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ConsensusDeployerAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SdsProxyAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SdsProxyAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvm(dAtA[iNdEx:])
